...
export const modes = {
  ...
  forehead: {
    ...
    controlChoice: true,
    role: "guesser",
    handoffLead: "Turn the phone sideways and hold it against your forehead, screen facing your team.",
    revealNote: null,
    promptLabel: null,
    countdownHint: "Hold it up",
    howTo: [
      "Pick a category.",
      "Turn the phone sideways and hold it against your forehead, screen facing your team.",
